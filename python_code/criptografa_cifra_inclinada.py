 class Cripto:
    ...
    def _espacos_por_underline(string):
    ...
    def _falsos_underlines_String(string, numberOfRows):
    ...
    def _validate_String(string, numberOfRows):
    ...
    def _encoding_String(self, string, numberOfRows):
        ...
        new_String = self._espacos_por_underline(string)                                            # substituo o valor dos espacos por underlines
        new_String, string_verdadeira = self._falsos_underlines_String(new_String, numberOfRows)    # garanto que a string tenha uma tamanho divisivel pelo numero de linhas, por se precisar colocar no final dela quantos underlines forem necessarios
