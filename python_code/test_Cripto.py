...
statement = """
cripto.encode_String("my name is", 3)
"""
...
statement = """
cripto.encode_String("nao havera borboletas se a vida nao passar por longas e silenciosas metamorfoses", 4)
"""
tempo = timeit.timeit(statement, setup, number=10) / 10
...
statement = """
cripto.encode_String("para mim as horas sao curtas e os dias pequenos por mais longas que sejam as horas e maiores que sejam dos dias nao sao suficientes para satisfazer a vontade que sinto de estar sempre com voce ", 6)
"""
tempo = timeit.timeit(statement, setup, number=10) / 10
